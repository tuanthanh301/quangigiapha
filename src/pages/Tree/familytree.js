...
(FamilyTree._defaultConfig = function (e) {
  ...
  (FamilyTree.prototype._hideBeforeAnimation = function (e) {
    if (
      ...
      var l = this.element.querySelectorAll(
        ...
        if (!1 !== this._fireUpdate_addUpdateRemove(c, a)) {
          ...
          d && (p = d.id),
            n._draw(!1, FamilyTree.action.update, { id: p }, function () {
              n.ripple(i.id),
                r && r(),
                FamilyTree.events.publish("updated", [n, c]),
                n.filterUI.update();
            }),
    ...
    if (e && Array.isArray(e.pids) && 1 == e.pids.length) {
      ...
      if (!1 !== this._fireUpdate_addUpdateRemove(n, i)) {
        ...
        r._draw(
          !1,
          FamilyTree.action.insert,
          { id: o, insertedNodeId: n.addNodesData[0].id },
          function () {
    ...
    if (this.canRemove(e)) {
      ...
      if (Array.isArray(a.pids))
        for (var l = 0; l < a.pids.length; l++) {
          ...
          if (o)
            -1 != (d = o.pids.indexOf(a.id)) &&
              (o.pids.splice(d, 1), n.push(o));
        }
      ...
      if (!1 !== this._fireUpdate_addUpdateRemove(c, i))
        -1 != (d = this.config.roots.indexOf(e)) &&
          this.config.roots.splice(d, 1),
          this._draw(!1, FamilyTree.action.update, null, function () {
            r.config.sticky &&
              FamilyTree._moveToBoundaryArea(
                r.getSvg(),
  ...
  (FamilyTree.prototype.updateNode = function (e, t, i) {
    ...
    for (var l = 0; l < a.pids.length; l++) {
      if (!e.pids.has(a.pids[l]))
        if ((s = this._get(a.pids[l])) && s.pids) {
          ...
          -1 != o && (s.pids.splice(o, 1), n.push(e)),
            a.pids.splice(l, 1),
            n.push(s);
        }
    }
    for (l = 0; l < e.pids.length; l++) {
      ...
      if (!a.pids || !a.pids.has(e.pids[l]))
        (s = this._get(e.pids[l])).pids || (s.pids = []),
          s.pids.push(e.pids[l]),
          n.push(s);
    }
        ...
        for (var m = 0; m < e.length; m++)
          for (var p in i[m]) {
            ...
            switch (p.toLowerCase()) {
              case "d":
                var f =
                    a((d * s - s) / r) * (i[m][p][0] - t[m][p][0]) + t[m][p][0],
                  u =
                    a((d * s - s) / r) * (i[m][p][1] - t[m][p][1]) + t[m][p][1];
                e[m].setAttribute(
                  "d",
    ...
    switch (i.orientation) {
      ...
      case FamilyTree.orientation.left_top:
        (r = e.x),
          ...
          (n = e.x),
          (l = e.y + e.h + i.siblingSeparation / 4);
    }
    var o,
      s,
      d,
  ...
  (FamilyTree.editUI.prototype.show = function (e, t, i) {
    ...
    for (
      var n = this.obj.element.querySelectorAll("[data-input-btn]"), l = 0;
      l < n.length;
      l++
    ) {
        ...
        a.focus(),
          a.nextElementSibling.addEventListener("click", function (e) {
            ...
            if (FamilyTree.isNEU(i) || n) a.focus();
              ...
              var l = FamilyTree.elements.textbox(
                {},
      ...
      this.obj.element
        ...
        .addEventListener("click", function (t) {
          ...
          if (i && i.hasAttribute) {
            ...
            if (!1 === FamilyTree.events.publish("button-click", [r, l]))
              return !1;
            switch (n) {
              case "edit":
  ...
  (FamilyTree.circleMenuUI.prototype._show = function (e, t) {
    ...
    if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
      ...
      if (
        FamilyTree.isNEU(h) ||
        h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e
      ) {
  ...
  (FamilyTree.wrapText = function (e, t) {
    ...
    if (-1 != m.indexOf("multiline")) {
      ...
      for (var F = 1, x = 1; x < g.length; x++) {
        ...
        if (
          ((b.firstChild.data += " " + g[x]), b.getComputedTextLength() > c)
        ) {
          if (
            ((b.firstChild.data = b.firstChild.data.slice(0, _)),
            F++,
            a && F > a)
          ) {
          ...
          (b = document.createElementNS(p, "tspan")).setAttributeNS(
            null,
            "x",
            o
          ),
      ...
      if (null != h.innerHTML) (k = h.innerHTML), (h.innerHTML = "");
        ...
        for (x = h.childNodes.length - 1; x >= 0; x--)
          (S = XMLSerializer().serializeToString(h.childNodes[x]) + S),
        ...
        if ("svg" == e.ext)
          if (t) t(e, a.innerHTML);
            ...
            if (
              ...
              o.styles &&
                (a.childNodes[0].insertAdjacentHTML("afterbegin", o.styles),
                (o.content = a.innerHTML)),
              !1 === s)
            )
              return !1;
            if (!1 === (s = FamilyTree.events.publish("exportend", [i, o])))
              return !1;
  ...
  (FamilyTree.prototype._pagesA100 = function (e, t, i) {
    ...
    for (
      var p = c.w * (100 / i), h = c.h * (100 / i), f = l, u = o, y = [];
      f < s + l;
  ...
  (FamilyTree.prototype._globalClickHandler = function (e, t) {
    ...
    for (var o = t.target; o != e; ) {
      ...
      if (o.hasAttribute(FamilyTree.attr.control_node_menu_id)) {
        ...
        (s = o.getAttribute(FamilyTree.attr.control_node_menu_id)),
          (d = this.getNode(s));
      ...
      if (o.hasAttribute(FamilyTree.attr.control_node_circle_menu_name))
        return (
          t.stopPropagation(),
          t.preventDefault(),
          void this._nodeCircleMenuItemClickHandler(o, t)
        );
      if (o.hasAttribute(FamilyTree.attr.control_add))
    ...
    if (n.draggable) {
      ...
      var b = function (e, t) {
          if (null != e) {
            ...
            for (
              var i = FamilyTree.getStParentNodes(l.getNode(c)), r = 0;
              r < i.length;
              r++
            ) {
    ...
    if (this.config.enableDragDrop) {
      ...
      var y = function (e, t) {
          if (null != e) {
            t.classList.remove("bft-drag-over");
            for (
              var i = s.getNode(l), r = FamilyTree.getStParentNodes(i), a = 0;
              a < r.length;
              a++
            ) {
          ...
          if (c) {
            ...
            if (g.left || g.right || g.up || g.down) {
              ...
              if (
                ...
                !1 === FamilyTree.events.publish("drag", [s, k, t]) && T(),
                  (e._dragEventFired = !0);
              u.setAttribute("transform", "matrix(" + m.toString() + ")");
            }
          }
        ...
        T = function (t) {
          if (
            ...
            return (
              e._dragEventFired &&
                FamilyTree.events.publish("drop", [s, n.id, void 0, u]),
              d.removeChild(u),
  ...
  (FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
    ...
    t.touches &&
      ...
      ((s.type = "pinch"),
      (s.dist = Math.sqrt(
        (l.x - o.x) * (l.x - o.x) + (l.y - o.y) * (l.y - o.y)
      ))),
      "pan" == s.type &&
    ...
    var d = function (e) {
        ...
        if (s && "pan" == s.type) {
          ...
          var o = FamilyTree._getClientTouchesXY(e, 1),
            d = Math.sqrt(
              (t.x - o.x) * (t.x - o.x) + (t.y - o.y) * (t.y - o.y)
            ),
    ...
    if (e) {
      if (e.hasAttribute("data-search-item-id")) {
        ...
        if (this.input.value != FamilyTree.SEARCH_HELP_SYMBOL)
          0 != FamilyTree.events.publish("searchclick", [this.obj, t]) &&
            this.obj.center(t);
        else
          (this.input.value = t + " "),
  ...
  (FamilyTree.searchUI.prototype._initSearchFields = function () {
    if (null == this.obj.config.searchFields) {
      ...
      for (var e = 0; e < this.obj.response.allFields.length; e++) {
        ...
        "tags" == t ||
          FamilyTree._fieldIsImg(this.obj.config, t) ||
  ...
  (FamilyTree.searchUI.prototype._search = function () {
      ...
      e = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
        for (
          ...
          if (i) {
            ...
            "function" == typeof i
              ? (n = i(t.obj, t.obj.getNode(a.id), l))
              : l[i] && (n = l[i]);
          }
          var o = "",
            s = "";
    ...
    for (
      var r = this.obj.element.querySelectorAll("[data-search-item-id]"), a = 0;
      a < r.length;
      a++
    )
      ...
      l._setPositions(
        ...
        function (t) {
          ...
          i.state &&
            ...
            (l = i.state.adjustify);
          for (
            var o = { minX: null, minY: null, maxX: null, maxY: null },
              s = {},
              d = 0;
            d < n.length;
            d++
  ...
  (FamilyTree.manager._initNode = function (e, t, i, r, a, n, l) {
    ...
    var T = { node: e };
    FamilyTree.events.publish("node-initialized", [l, T]),
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
    for (
      ...
      FamilyTree.isNEU(p.ppid) || (u.ppid = p.ppid),
        ...
        null != i.orderBy &&
          (u.order = FamilyTree.manager._getOrderFieldValue(p, i.orderBy)),
        (e[p.id] = u),
        s.push(p.id);
    }
    null != i.orderBy &&
  ...
  (FamilyTree.manager._createNodes = function (e) {
    var t = e.manager.config,
      ...
      d = [];
    if (
      (FamilyTree.manager.__createNodes(o, s, t, r, a, n, d, e),
      null != t.roots)
    ) {
      s = [];
        ...
        if (m) {
          ...
          if (!f) {
            if (!FamilyTree.isNEU(m.pid))
              (H = (b = o[m.pid]).childrenIds.indexOf(m.id)) > -1 &&
                b.childrenIds.splice(H, 1);
            s.push(m);
          }
        }
      }
    ...
    if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == l)
      for (c = 0; c < t.expand.nodes.length; c++) {
        ...
        for (
          ...
          FamilyTree.manager._addExpandedNodeIdsIterate(g, o, y);
          g;
      ...
      for (var v = o[a.id]; v; ) {
        if (
          (y.push(v.id),
          a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && v)
        )
    ...
    var _ = [],
      ...
      C = [];
    for (c = 0; c < s.length; c++)
      FamilyTree.manager._iterate(s[c], s[c], o, 0, _, w, k, S, "", y, C, e);
    if (
    ...
    for (c = 0; c < C.length; c++) {
      ...
      for (F = N.length - 1; F >= 0; F--)
        if (M[N[F]])
          for (u = 0; u < M[N[F]].length; u++)
            g.children.push(o[M[N[F]][u]]),
              L++,
              -1 == B.indexOf(N[F]) && B.push(N[F]);
      ...
      for (F = 0; F < A.length; F++)
        if (M[A[F]])
          for (u = 0; u < M[A[F]].length; u++)
            g.children.push(o[M[A[F]][u]]),
              O++,
              -1 == U.indexOf(A[F]) && U.push(A[F]);
      ...
      (g.partnerSeparation =
        Math.max(B.length, U.length) * t.partnerChildrenSplitSeparation +
    ...
    for (c = 0; c < k.length; c++) {
      if (
        (ae = i[(g = o[k[c]]).lcn ? g.lcn : "base"]).layout ==
          FamilyTree.normal ||
        !S[g.pid]
      )
        for (F = 0; F < g.subLevels; F++) {
          var H,
            j = new FamilyTree.node(
              g.id + "_sub_level_index_" + F,
              g.pid,
              [],
              "subLevel"
            );
          if ((FamilyTree.manager._initDinamicNode(j, g.lcn), (b = g.parent)))
            (H = b.children.indexOf(g)) > -1 &&
              (b.children.splice(H, 1), b.children.splice(H, 0, j)),
              j.children.push(g),
              (j.parent = b),
              (g.parent = j),
              (o[j.id] = j);
    ...
    for (var $ in w) {
          ...
          : z.isPartner ||
            (z.parent &&
              ...
              (Object.defineProperty(
                S,
                j.id,
                Object.getOwnPropertyDescriptor(S, z.parent.id)
              ),
      ...
      for (F = Y.length - 1; F >= 0; F--)
        if (F % 2 && F != Y.length - 1) {
          var W = new FamilyTree.node(
            b.id + "_split_assitant_" + V,
            b.pid,
            [],
            "split"
          );
      ...
      for (var $ in S) {
        ...
        if (
          ...
          if (
            ...
            FamilyTree.manager._initDinamicNode(j, b.lcn),
              (o[j.id] = j),
    ...
    if (FamilyTree.VERTICAL_CHILDREN_ASSISTANT)
      for (c = 0; c < s.length; c++)
        FamilyTree.manager._verticalAssistantIterate(s[c], o);
    ie = { nodes: o, roots: s };
    return (
  ...
  (FamilyTree.manager._getResponse = function (
    ...
    if (
      ...
      if (_ - 2 * r.padding >= n - o)
        ...
        switch (
          ((k = -(_ / 2 - (n - o) / 2)) > -r.padding && (k = -r.padding),
          r.orientation)
        ) {
          case FamilyTree.orientation.bottom:
          case FamilyTree.orientation.bottom_left:
    ...
    for (var A = 0; A < d.length; A++)
      FamilyTree.manager._iterate2(d[A], p, r, s, c, m, y, h, i, T);
    return {
      animations: T,
      boundary: g,
      viewBox: s,
  ...
  (FamilyTree.manager._iterate2 = function (e, t, i, r, a, n, l, o, s, d) {
      ...
      if (
        ...
        if (((c = { x: (f = o[e.id]).x, y: f.y }), f)) {
          ...
          for (var m = e, p = null; null != m; )
            o[m.id] && o[m.id].collapsed && (p = m), (m = m.parent);
        ...
        if (
          (null != (f = o[e.id]).x && null != f.y && (c = { x: f.x, y: f.y }),
          (h = t[n.id]) && h == e)
        )
          (m = e.parent) &&
            m.id == n.id &&
            (c = { x: h.x + h.w / 2 - e.w / 2, y: h.y + h.h / 2 - e.h / 2 });
    ...
    for (y = 0; y < e.children.length; y++)
      FamilyTree.manager._iterate2(e.children[y], t, i, r, a, n, l, o, s, d);
  }),
  ...
  (FamilyTree.manager._doNotChangePositionOfClickedNodeIfAny = function (
    ...
    var l = r.id;
    ((i == FamilyTree.action.minimize && t[l].parent) ||
      (i == FamilyTree.action.maximize && t[l].parent)) &&
      (l = t[l].pid);
    var o = t[l],
      s = a[l];
    return s
      ? { x: (s.x ? s.x : 0) - o.x, y: (s.y ? s.y : 0) - o.y }
      : { x: 0, y: 0 };
  }),
  (FamilyTree.manager._verticalAssistantIterate = function (e, t) {
    ...
    if (e.isAssistant && e.isSplit && e.children.length) {
      ...
      if (d.length) {
        for (
          var m = d[d.length - 1], p = d[0], h = e.children.length - 1;
          h >= 0;
          h--
        ) {
          var f = e.children[h];
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
    ...
    for (p = 0; p < d.length; p++) {
      ...
      if (b) {
        var v = [];
        FamilyTree.manager._iterateSetRootIds(b.id, b.id, m, c, e, v),
          l.push(v);
      }
    }
  ...
  (FamilyTree.manager._iterateSetRootIds = function (e, t, i, r, a, n) {
    ...
    if (l) {
      ...
      for (var o = 0; o < l.rids.length; o++)
        n.has(l.rids[o]) || n.push(l.rids[o]);
      ...
      if (i[l.id])
        for (o = 0; o < i[l.id].length; o++)
          FamilyTree.manager._iterateSetRootIds(i[l.id][o], t, i, r, a, n);
      if (r[l.id])
        for (o = 0; o < r[l.id].length; o++)
          FamilyTree.manager._iterateSetRootIds(r[l.id][o], t, i, r, a, n);
    }
  }),
  (FamilyTree.manager._iterateFT = function (e, t, i, r, a, n, l, o, s) {
    ...
    if (t[e])
      for (b = 0; b < t[e].length; b++)
        FamilyTree.manager._iterateFT(t[e][b], t, i, r, a, n, l, o, s);
    if (i[e])
      for (b = 0; b < i[e].length; b++)
        FamilyTree.manager._iterateFT(i[e][b], t, i, r, a, n, l, o, s);
  }),
  (FamilyTree.manager.getAllFields = function (e) {
    var t = [FamilyTree.TAGS];
    for (var i in e.nodeBinding) t.push(e.nodeBinding[i]);
  ...
  (FamilyTree.ui = {
    ...
    link: function (e, t, i, r, a, n) {
      ...
      (e.layout != FamilyTree.mixed && e.layout != FamilyTree.tree) ||
        (c = o.mixedHierarchyNodesSeparation / 2);
      var m = 0,
            ...
            ? ((f.ppnodes[y.id] = y.parentPartner),
              ...
              1 == y.parentPartner.isPartner
                ...
                : 2 == y.parentPartner.isPartner &&
                  ...
                  (f.lastLeft = y)))
            : y.isPartner ||
              ((f.lastLeft = y), f.firstRight || (f.firstRight = y));
        }
        ...
        if (y.isChildOfPartner)
          ...
          if (
            ...
            switch (o.orientation) {
              ...
              case FamilyTree.orientation.top_left:
                if (1 == y.isPartner)
                  T = FamilyTree.ui._linkLeftToRight(e, y, s, m);
                else if (2 == y.isPartner)
                  T = FamilyTree.ui._linkRightToLeft(e, y, s, m);
                else {
              ...
              case FamilyTree.orientation.right_top:
                if (1 == y.isPartner)
                  T = FamilyTree.ui._linkTopToBottom(e, y, s, m);
                else if (2 == y.isPartner)
                  T = FamilyTree.ui._linkBottomToTop(e, y, s, m);
                else {
                  v = 1 == y.layout ? void 0 : g.maxX - (g.maxX - h.minX) / 2;
    ...
    _linkPpTop: function (e, t, i, r, a, n) {
      ...
      return (
        (s = c.mid),
        FamilyTree.ui._linkTopToBottom({ x: m, y: o, w: 0, h: 0 }, i, n, 0, s)
      );
    },
    _linkPpBottom: function (e, t, i, r, a, n) {
      ...
      return (
        (s = c.mid),
        FamilyTree.ui._linkBottomToTop({ x: m, y: o, w: 0, h: 0 }, i, n, 0, s)
      );
    },
    _linkPpLeft: function (e, t, i, r, a, n) {
      ...
      return (
        (o = c.mid),
        FamilyTree.ui._linkLeftToRight({ x: d, y: m, w: 0, h: 0 }, i, n, 0, o)
      );
    },
    _linkPpRight: function (e, t, i, r, a, n) {
      ...
      return (
        (o = c.mid),
        FamilyTree.ui._linkRightToLeft({ x: d, y: m, w: 0, h: 0 }, i, n, 0, o)
      );
    },
  ...
  (FamilyTree.pdfPrevUI._handler = function (e, t, i) {
    ...
    o.classList.add(e.config.mode),
      ...
      FamilyTree._browser().msie &&
        (o.innerHTML = new XMLSerializer().serializeToString(i));
    for (
        ...
        for (var y = t; null == d; ) {
          ...
          if (!g) {
            ...
            if (T.parent)
              switch (
                ((f = p.levelSeparation),
                (T.parent.layout != FamilyTree.mixed &&
                  T.parent.layout != FamilyTree.tree) ||
                  (f = p.mixedHierarchyNodesSeparation),
                p.orientation)
              ) {
                case FamilyTree.orientation.top:
      ...
      if (Array.isArray(n)) for (var l = 0; l < n.length; l++) e(t, n[l]);
        ...
        for (l = 0; l < n.stChildrenIds.length; l++)
          r++,
            ...
            r--;
        for (l = 0; l < n.childrenIds.length; l++)
          e(t, t.getNode(n.childrenIds[l]));
      }
    })(e, e.roots);
  }),
  ...
  (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
    ...
    for (
      var l = a.length / 100, o = 0, s = 0, d = o > 0 ? 100 : 0, c = 0, m = 0;
      m < e.length;
      m++
    )
    ...
    for (h = n.length - 1; h >= 0; h--)
      b = (b = b.insert(n[h].start + n[h].length, "</mark>")).insert(
        n[h].start,
        "<mark>"
      );
    ...
    if (o) {
      ...
      o.writeToIndexedDB &&
        ...
        o.writeToLocalStorage &&
          FamilyTree.localStorage.setItem(o.name, JSON.stringify(d));
    }
  }),
    ...
    if (e) {
      ...
      if (e.readFromUrlParams) {
        ...
        if (
          ...
          return (
            (l.adjustify = { x: parseFloat(c[0]), y: parseFloat(c[1]) }),
            void r(l)
          );
        }
    ...
    if (n || l) {
      ...
      if (
        (o &&
          ...
          l.setAttribute(
            "transform",
            "matrix(" + o.transformStart.toString() + ")"
          ),
  ...
  (FamilyTree.prototype.showTreeMenu = function (e) {
    ...
    for (s = 0; s < t.ftChildrenIds.length; s++)
      o.push(this.get(t.ftChildrenIds[s]));
    var c = this.get(e);
    ...
    if (n) m.push(n);
      ...
      (c.mid = p.id),
        a
          ? ((a.pids = [p.id]), (p.pids = [a.id]), (p._ft_data.pids = [a.id]))
          : (p.pids = ["_ft_father"]),
        m.push(p);
    }
    if (a) m.push(a);
      ...
      for (s = 0; s < c.pids.length; s++) {
        ...
        for (var g = 0; g < o.length; g++)
          (o[g].mid != c.pids[s] && o[g].fid != c.pids[s]) ||
            ((o[g].mid = void 0),
            (o[g].fid = void 0),
            (o[g].stpid = "_ft_child_group_" + s),
            m.push(o[g]));
      }
    var T = [];
    for (g = 0; g < o.length; g++)
      ((o[g].fid == c.id && FamilyTree.isNEU(o[g].mid)) ||
        (o[g].mid == c.id && FamilyTree.isNEU(o[g].fid))) &&
        (o[g].fid == c.id
    ...
    if (T.length) {
      ...
      "male" == c.gender
        ...
        : "female" == c.gender &&
          ((b.templateName = "husband"), (b._ft_partnerData.gender = "male")),
        c.pids.push(b.id),
        m.push(b);
    }
  ...
  (FamilyTree.filterUI.prototype.show = function (e) {
    var t = this.instance.element.querySelector(
      '[data-filter-field="' + e + '"]'
    );
    t && t.click();
  }),
  ...
  (FamilyTree.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      ...
      if ("all" == this.instance.config.filterBy)
        ...
        for (t = 0; t < this.instance.config.filterBy.length; t++)
          e[this.instance.config.filterBy[t]] = {};
      ...
      if (null != this.filterBy)
        for (var o in e)
          if (this.filterBy[o])
            for (var s in e[o])
              this.filterBy[o][s] && (e[o][s] = this.filterBy[o][s]);
      this.filterBy = e;
      var d = this,
      ...
      var m = "";
      for (var o in this.filterBy)
        m += `<div data-filter-field="${o}">${o}</div>`;
      (c.innerHTML = `<div>${m}</div>`),
        c.addEventListener("click", function (e) {
          if (
            ...
            var l = d.instance.element.querySelector(
              `[data-filter-menu="${t}"]`
            );
            if (!l) {
  ...
  (FamilyTree.remote._setPositions = function (e, t, i, r) {
    for (
      var a = [],
        n = [],
        l = FamilyTree.remote._toReqLayoutConfigsDTO(t),
        o = 0;
      o < e.length;
      o++
    )
